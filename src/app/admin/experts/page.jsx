...
const ExpertsList = () => {
  ...
  const fetchExperts = async () => {
    try {
      ...
      const res = await axios.get('https://api.doubtsclear.com/api/admin/getAllExperts', {
    ...
    <div className="flex min-h-screen bg-black">
      ...
      <main className="flex-1 p-6 bg-white">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-bold text-gray-800">Experts Management</h1>
          <button
        ...
        <div className="mb-6">
          <input
            ...
            className="w-full px-4 py-2 border-b-2 text-black border-gray-300 focus:border-[#E53935]"
            value={searchTerm}
                  ...
                  <tr key={expert._id} className="border-b border-gray-200 hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex space-x-2">
                        <button onClick={() => openViewModal(expert)} className="text-blue-600 hover:text-blue-900">
                          <FiEye />
                        </button>
